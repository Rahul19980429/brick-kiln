...
const AllPurchaseEntry = () => {
    ...
    const { getAllPurchaseBill, members, getAllMember, setError, logOutClick, spinner,activeStatusUser } = a;
                                    ...
                                    searchInput.textSearch === '' ?
                                        purchaseBill.map((data, index) => {
                                            ...
                                            return (<tr key={data._id}><><td className='border-end border-dark'>{index + 1}</td>
                                                ...
                                                <td className='border-end border-dark'>{Math.round(data.supplierLastBalance)}</td>
                                                ...
                                                <td className='border-end border-dark'>{Math.round(parseFloat(-amount) + parseFloat(data.supplierLastBalance) + parseFloat(allVariable.payAmountTotal) - parseFloat(allVariable.recAmountTotal) + parseFloat(data.discountInfo.amount ? data.discountInfo.amount : 0))}</td>
