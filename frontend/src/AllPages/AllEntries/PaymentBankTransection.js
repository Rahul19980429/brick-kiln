    ...
    return (
        localStorage.getItem('Jwt_token') && localStorage.getItem('user_activeStatus') === 'true' ?
            <div className='container-fluid'>
                ...
                <div className='row flex flex-column-reverse flex-lg-row '>
                    <div className='col-lg-10 col-12' ref={componentRef} style={{overflowX:'scroll'}} >
                                            ...
                                            return (<tr key={data._id}>
                                                ...
                                                <><td className='border-end border-dark'>{index + 1}</td>
                                                    ...
                                                    <td className='border-end border-dark'>
                                                        <table>
                                                            <tbody>
                                                                {data.paymentInfo.length > 0 ? data.paymentInfo.filter((bankData) => bankData.mode === 'online').map((data, index) => {
...
export default PaymentBankTransection
