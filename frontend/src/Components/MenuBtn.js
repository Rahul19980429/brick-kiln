...
const Menubtn = () => {
  ...
  return (
    ...
    <div className='container'>
      <button className="btn btn-primary rounded-pill position-fixed" style={{zIndex:'1111',bottom:'6%', right:'2%'}} id="menubtn" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions">
